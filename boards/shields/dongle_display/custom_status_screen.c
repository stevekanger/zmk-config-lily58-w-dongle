...
lv_obj_t *zmk_display_status_screen() {
    ...
    lv_obj_t *output_status_obj = zmk_widget_output_status_obj(&output_status_widget);
    lv_obj_add_style(output_status_obj, &alternate_font_style, LV_PART_MAIN);
    ...
    lv_obj_t *layer_status_obj = zmk_widget_layer_status_obj(&layer_status_widget);
    lv_obj_align(layer_status_obj, LV_ALIGN_BOTTOM_LEFT, 0, 0);

    // Battery status widget
    zmk_widget_dongle_battery_status_init(&dongle_battery_status_widget, screen);
    lv_obj_t *battery_status_obj =
        zmk_widget_dongle_battery_status_obj(&dongle_battery_status_widget);
    lv_obj_align(battery_status_obj, LV_ALIGN_TOP_RIGHT, 0, 0);
